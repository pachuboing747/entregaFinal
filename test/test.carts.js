...
describe('Router de carts', () => {
    ...
    it('confirma que hay productos en el carrito', async function() {
        this.timeout(10000);
        const carrito = await cartDao.getCart();
        expect(carrito).to.not.deep.equal([])
    });

    it('se registra un producto en el carrito', async function() {
        this.timeout(10000);
        const carrito = await cartDao.addCart ({
